...
from inc.misc import getuptime # import inc.misc as misc
from inc.utime import ticks_ms # import inc.utime as utime
from inc.unet import get_rssi #import inc.unet as unet
from inc.libhw import FreeMem #import inc.libhw as libhw
from inc.lib_plat import read_cpu_temp #import inc.lib_plat as lib_plat
...
class Plugin(plugin.PluginProto):
 ...
 def plugin_read(self): # deal with data processing at specified time interval
  ...
  if self.initialized and self.readinprogress==0:
   ...
   self._lastdataservetime = ticks_ms()
   result = True
   self.readinprogress = 0
  return result
